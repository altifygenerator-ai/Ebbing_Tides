...
const r=(id:string,type:ArtLayoutManifest["regions"][string]["type"],x:number,y:number,width:number,height:number,extra:Partial<ArtLayoutManifest["regions"][string]>={})=>({id,type,x,y,width,height,...extra});
export const navalEncounterLayout: ArtLayoutManifest = {
