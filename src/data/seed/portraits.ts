import type { PortraitChoice, ReligionId } from "../../game/types.js";

const generalFaiths: ReligionId[] = ["old_gods", "covenant", "pantheon", "turning_wheel", "unaffiliated"];
const northwesternFaiths: ReligionId[] = ["old_gods", "unaffiliated"];
const pantheonFaiths: ReligionId[] = ["pantheon"];
const asterianFaiths: ReligionId[] = ["pantheon", "unaffiliated"];
const serathiFaiths: ReligionId[] = ["covenant", "unaffiliated"];
const kaishinFaiths: ReligionId[] = ["turning_wheel", "unaffiliated"];
const wheelFaiths: ReligionId[] = ["turning_wheel"];
const vesperanFaiths: ReligionId[] = ["covenant", "pantheon", "unaffiliated"];
const outerIslesFaiths: ReligionId[] = ["unaffiliated", "old_gods"];
const outerMerchantFaiths: ReligionId[] = ["unaffiliated", "covenant"];
...
export const PORTRAIT_CHOICES: PortraitChoice[] = [
  {
...
export const PORTRAIT_BY_ID = Object.fromEntries(PORTRAIT_CHOICES.map((portrait) => [portrait.portraitId, portrait])) as Record<string, PortraitChoice>;
