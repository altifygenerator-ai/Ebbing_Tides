import type { NpcCharacter } from "../../game/types.js";

export const NPC_SEEDS: NpcCharacter[] = [
  {
...
export const NPC_BY_ID = Object.fromEntries(NPC_SEEDS.map((npc) => [npc.id, npc])) as Record<string, NpcCharacter>;
