# Apply Character / RPG Pass 1C — Painted Manuscript Integration

Apply this overlay to the accepted **Alpha 0.6D Character / RPG Pass 1B** project.

1. Back up the current project.
2. Copy the contents of `ET_Alpha_0.6D_Character_RPG_Pass_1C_PATCH/` into the project root, preserving paths and overwriting matching files.
3. Run `npm test`.
...
Expected package version: `0.6.0-alpha.d.character1c`.
