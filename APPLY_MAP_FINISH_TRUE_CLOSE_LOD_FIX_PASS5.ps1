...
Write-Host 'MAP FINISH TRUE CLOSE LOD FIX PASS 5 APPLIED: 24k close tiles now replace 12k tiles correctly; marker styles and navigation/audio stack unchanged.'
