...
const YEAR = (year) => ({ precision: "year", year });
const APPROX = (year) => ({ precision: "approximate", year });
/**
 ...
 */
export const HISTORICAL_DYNASTIES_06B_SEED = {
    characters: [
...
//# sourceMappingURL=dynasties.js.map