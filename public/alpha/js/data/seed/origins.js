...
export const ORIGIN_SETTLEMENTS = [
...
export const ORIGIN_SETTLEMENT_BY_ID = Object.fromEntries(ORIGIN_SETTLEMENTS.map((row) => [row.id, row]));
export const HOMELAND_REGION_LABELS = {
...
export function originSettlementName(id) {
