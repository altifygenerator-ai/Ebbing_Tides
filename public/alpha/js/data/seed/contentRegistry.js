 ...
 */
export const SHIP_CLASS_DEFINITIONS = [
    {
...
export const LEGACY_SHIP_CLASS_ALIASES = {
...
export const SHIP_CLASS_BY_ID = Object.fromEntries(SHIP_CLASS_DEFINITIONS.map((row) => [row.id, row]));
export const CONTENT_BY_ID = Object.fromEntries(CONTENT_DEFINITIONS.map((row) => [row.id, row]));
export function resolveShipClassId(id) {
    return SHIP_CLASS_BY_ID[id] ? id : (LEGACY_SHIP_CLASS_ALIASES[id] ?? id);
}
export function shipClassDefinition(id) {
    return SHIP_CLASS_BY_ID[resolveShipClassId(id)];
}
export function contentDefinition(id) {
