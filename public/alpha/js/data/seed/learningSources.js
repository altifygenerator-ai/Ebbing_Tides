...
export const LEARNING_SOURCE_BY_ID = Object.fromEntries(LEARNING_SOURCES.map(source => [source.id, source]));
export const RELIGIOUS_INSTITUTIONS = [
...
export const RELIGIOUS_INSTITUTION_BY_PORT = Object.fromEntries(RELIGIOUS_INSTITUTIONS.map(row => [row.portId, row]));
//# sourceMappingURL=learningSources.js.map