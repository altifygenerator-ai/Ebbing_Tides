 ...
 */
export async function saveGameToSupabase(state, config) {
    ...
    if (!response.ok)
        return { ok: false, message: `Cloud save failed (${response.status}).` };
    return { ok: true, message: "Campaign snapshot saved to Supabase." };
}
export async function loadGameFromSupabase(saveId, config) {
...
//# sourceMappingURL=cloudSave.js.map